...
class _CreditCard extends StatelessWidget {
  const _CreditCard({required this.imageAsset, required this.title, required this.body});
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    body,
                    style: const TextStyle(fontFamily: 'jomolhari', height: 1.7, wordSpacing: 2),
                  ),
                ),
              ],
            ),
